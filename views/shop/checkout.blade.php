                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td class="product-in-table">
                                        <img class="img-responsive" src="{{ theme_asset('img/thumb/08.jpg') }}" alt="">
                                ...
                                <tr>
                                    <td class="product-in-table">
                                        <img class="img-responsive" src="{{ theme_asset('img/thumb/07.jpg') }}" alt="">
                                ...
                                <tr>
                                    <td class="product-in-table">
                                        <img class="img-responsive" src="{{ theme_asset('img/thumb/06.jpg') }}" alt="">
                                ...
                                <tr>
                                    <td class="product-in-table">
                                        <img class="img-responsive" src="{{ theme_asset('img/thumb/09.jpg') }}" alt="">
...
@section('scripts-plugins')
    @parent
    <script src="{{ theme_asset('plugins/jquery-steps/build/jquery.steps.js') }}"></script>
...
@section('scripts-app')
    ...
    <script src="{{ theme_asset('js/forms/shop/login.js') }}"></script>
    <script src="{{ theme_asset('js/plugins/stepWizard.js') }}"></script>
