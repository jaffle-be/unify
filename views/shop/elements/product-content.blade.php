<div class="container content-md">
        ...
        <ul class="list-inline owl-slider">
            <li class="item">
                <div class="product-img">
                    <a href="{{ route('shop.product') }}"><img class="full-width img-responsive" src="{{ theme_asset('img/blog/09.jpg') }}" alt=""></a>
            ...
            <li class="item">
                <div class="product-img">
                    <a href="{{ route('shop.product') }}"><img class="full-width img-responsive" src="{{ theme_asset('img/blog/26.jpg') }}" alt=""></a>
                    <a class="product-review" href="{{ route('shop.product') }}">Quick review</a>
                    <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                </div>
                <div class="product-description product-description-brd">
            ...
            <li class="item">
                <div class="product-img">
                    <a href="{{ route('shop.product') }}"><img class="full-width img-responsive" src="{{ theme_asset('img/blog/11.jpg') }}" alt=""></a>
                    <a class="product-review" href="{{ route('shop.product') }}">Quick review</a>
                    <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
            ...
            <li class="item">
                <div class="product-img">
                    <a href="{{ route('shop.product') }}"><img class="full-width img-responsive" src="{{ theme_asset('img/blog/12.jpg') }}" alt=""></a>
                    <a class="product-review" href="{{ route('shop.product') }}">Quick review</a>
                    <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
            ...
            <li class="item">
                <div class="product-img">
                    <a href="{{ route('shop.product') }}"><img class="full-width img-responsive" src="{{ theme_asset('img/blog/10.jpg') }}" alt=""></a>
                    <a class="product-review" href="{{ route('shop.product') }}">Quick review</a>
                    <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                </div>
                <div class="product-description product-description-brd">
    ...
    <div class="row illustration-v2">
        <div class="col-md-3 col-sm-6 md-margin-bottom-30">
            <div class="product-img">
                <a href="{{ route('shop.product') }}"><img class="full-width img-responsive" src="{{ theme_asset('img/blog/25.jpg') }}" alt=""></a>
                <a class="product-review" href="{{ route('shop.product') }}">Quick review</a>
                <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
            </div>
            <div class="product-description product-description-brd">
