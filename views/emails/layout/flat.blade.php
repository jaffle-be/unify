...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
        <td width="100%" valign="top" bgcolor="#ffffff" style="padding-top:20px">
            ...
            @include('theme.unify::emails.layout.flat.header')
            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                <tr>
                    <td width="100%" valign="top" style="padding: 0px " class="center">
                        <a href="#"><img class="deviceWidth" width="700" hight="350" src="{{ theme_asset('img/headliner/headliner_green.jpg') }}"></a>
                    </td>
                </tr>
            </table>
            <!-- End Headliner-->
            ...
            @include('theme.unify::emails.layout.flat.footer')
