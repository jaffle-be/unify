...
@section('breadcrumb')
    @include('theme.unify::contact.elements.breadcrumbs')
@stop
    ...
    <div class="container content">
        <div class="row margin-bottom-30">
            <div class="col-md-9 mb-margin-bottom-30">
                ...
                @else
                    <form action="{{ route('store.contact.store') }}" method="post" id="sky-form3" class="sky-form contact-style">
            ...
            <div class="col-md-3">
                @include('theme.unify::contact.elements.contacts', ['map' => true, 'margin' => true, 'height' => 'map-box-space1'])

                @include('theme.unify::contact.elements.hours')


                {{--skip including widget for contact simple... it just don't fit into the page flow.--}}
                {{--@include('theme.unify::contact.elements.widget')--}}
            </div>
            <!--/col-md-3-->
        </div>
        <!--/row-->

        @include('theme.unify::marketing.widgets.clients')
    </div>
@stop
