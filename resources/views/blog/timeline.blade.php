    ...
    <div class="container content">
        <ul class="timeline-v1">
            <li>
                ...
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <img class="img-responsive" src="{{ theme_asset('img/main/img12.jpg') }}" alt=""/>
                    </div>
            ...
            <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <img class="img-responsive" src="{{ theme_asset('img/main/img6.jpg') }}" alt=""/>
                    </div>
                    <div class="timeline-body text-justify">
                        ...
                        <div class="carousel slide carousel-v1" id="myCarousel">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="img-responsive" src="{{ theme_asset('img/main/img7.jpg') }}" alt=""/>
                                ...
                                <div class="item">
                                    <img class="img-responsive" src="{{ theme_asset('img/main/img9.jpg') }}" alt=""/>
            ...
            <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <img class="img-responsive" src="{{ theme_asset('img/main/img3.jpg') }}" alt=""/>
                    </div>
                    <div class="timeline-body text-justify">
            ...
            <li>
                ...
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <img class="img-responsive" src="{{ theme_asset('img/main/img1.jpg') }}" alt=""/>
                    </div>
                    <div class="timeline-body text-justify">
