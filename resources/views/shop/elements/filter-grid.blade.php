        ...
        <div class="row illustration-v2 margin-bottom-30">
            <div class="col-md-4">
                <div class="product-img product-img-brd">
                    ...
                    <a class="product-review" href="{{ store_route('store.shop.product', [$product]) }}">Quick review</a>
                ...
                <div class="product-description product-description-brd margin-bottom-30">
                    <div class="overflow-h margin-bottom-5">
                        <div class="pull-left">
                            <h4 class="title-price"><a href="{{ store_route('store.shop.product', [$product]) }}">Double-breasted</a></h4>
