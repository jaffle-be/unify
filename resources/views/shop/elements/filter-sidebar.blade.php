            ...
            <div id="collapseFive" class="panel-collapse collapse in">
                <div class="panel-body">
                    <ul class="list-inline product-color-list">
                        <li><a href="#"><img src="{{ theme_asset('img/colors/01.jpg') }}" alt=""></a></li>
                        <li><a href="#"><img src="{{ theme_asset('img/colors/02.jpg') }}" alt=""></a></li>
                        <li><a href="#"><img src="{{ theme_asset('img/colors/03.jpg') }}" alt=""></a></li>
                        <li><a href="#"><img src="{{ theme_asset('img/colors/04.jpg') }}" alt=""></a></li>
                        <li><a href="#"><img src="{{ theme_asset('img/colors/05.jpg') }}" alt=""></a></li>
                        <li><a href="#"><img src="{{ theme_asset('img/colors/06.jpg') }}" alt=""></a></li>
                        <li><a href="#"><img src="{{ theme_asset('img/colors/07.jpg') }}" alt=""></a></li>
                    </ul>
                </div>
            </div>
        </div>
